...
/*   Updated: 2022/12/04 20:23:09 by jlucas-s         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	locate_better_option(t_stack *stack, t_better *better)
{
	...
	better->moves = ((stack->amount_a + stack->amount_b) / 2) + 1;
	index_b = -1;
...
/*
 * [ ] Verificar momentos de usar movimentos das duas stacks, tanto na locate tanto na long;
 * [ ] Ao invez de usar turn_to_three, verificar a stack e deixar os numeros que ja estão em
 * 		ordem crescente (testar, mas acho que vai ficar mais otimizado sim);
 * [ ] No tester ta travando as vezes com 5 numeros, verificar isso;
*/
